...
Send an email to [info@goodeggmath.com](mailto:info@goodeggmath.com) or fill out the [contact form](/#contact) to schedule your first session. Time slots range from 30 - 60 minutes and are available on Mondays & Wednesdays from 3pm - 6pm on any day the Sumas Library is open.
...
Questions? Concerns? Hit me up at [info@goodeggmath.com](mailto:info@goodeggmath.com).
